---
title: Compare Datasets using Dynamic Task Mapping
desc: This DAG shows an example implementation of comparing data between two S3 buckets and a table in Snowflake using the new .zip() method of the XComArg object.
tags:
